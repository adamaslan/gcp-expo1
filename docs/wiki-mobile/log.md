...
## [2026-08-31] ingest | Portal PR #89 fix(stripe): both price IDs wrong + no portal webhook endpoint — parity unaffected; headline resynced ~66% → ~62% to match wiki-portal | pages touched: 2

## [2026-08-31] ingest | Portal PR #91 fix(signals): Go Deeper contract drift repaired — portal-only, no mobile counterpart, headline unchanged ~62% | pages touched: 1

## [2026-09-01] ingest | Our PR #39 feat(shared): mirror attribution.ts + register in drift guard | pages touched: 3
