...
export default function HomeScreen() {
  ...
  const QUICK_LINKS = [
    { label: "Market Overview", route: "/demo/market" as const, color: "#3b82f6" },
    { label: "Signals", route: "/demo/signals" as const, color: "#10b981" },
    { label: "Industries", route: "/demo/industries" as const, color: "#8b5cf6" },
    { label: "Screener", route: "/demo/screener" as const, color: "#f59e0b" },
  ];
